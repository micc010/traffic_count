...
class ContourDetection(PipelineProcessor):
    ...
    def __init__(self, bg_subtractor, min_contour_width=25, min_contour_height=12, 
                 max_contour_width=200, max_contour_height=200, save_image=False, image_dir='images'):
    ...
    def __call__(self, context):
        ...
        fg_mask = self.bg_subtractor.apply(frame, None, -1)
...
class VehicleCounter(PipelineProcessor):
    '''
        ...
        path_size - max number of points in a path.Sensitivity
        max_dst - max distance between two points.Sensitivity
    '''

    def __init__(self, exit_masks=[], path_size=3, max_dst=10, x_weight=1.0, y_weight=1.0):
